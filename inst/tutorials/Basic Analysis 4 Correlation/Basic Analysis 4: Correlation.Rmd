...
```{r correlation_plot_2, exercise = TRUE, exercise.lines = 20, fig.width = 6}
...
# Sample size NB this is complicated because there
# are some NA (missing values) in the data set
n1 <- length(which(is.na(mhc$Promiscuity_in_vitro)== FALSE))
